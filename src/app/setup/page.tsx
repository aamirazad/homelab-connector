    ...
    <div>
      ...
      <div className="mx-auto flex flex-wrap gap-x-6">
        <button
          ...
          className={`rounded-xl bg-blue-600 px-4 py-2 text-white ${activeTab === 0 ? "bg-slate-600 opacity-50" : "opacity-100"}`}
        >
          Back
        </button>
        <button
          ...
          onClick={() => setActiveTab((prev) => prev + 1)}
          className={`rounded-xl bg-blue-600 px-4 py-2 text-white ${activeTab === formElements.length - 1 ? "bg-slate-600 opacity-50" : "opacity-100"}`}
        >
          Next
        </button>
